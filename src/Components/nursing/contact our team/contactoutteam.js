        ...
        <div className="container-fluid backgroundapa" id="footer">
            ...
            <div className="container-fluid ">
                <div className="row  d-flex flex-column justify-content-between  ">
                    ...
                    <div className="col-sm-12 col-lg-5 row boder mb-5 ms-1 bg-white ">
                        ...
                        <div className="col-sm-12 col-lg-6">
                          ...
                          <p className=" me-4 d-flex align-items-center justify-content-center">
                          <FontAwesomeIcon icon={faEnvelope} className="me-2 colr"/> kamalvignesh.v@kggeniuslabs.com</p>
