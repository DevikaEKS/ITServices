...
// // //         <h1 className='text-light pt-4'>SERVICES</h1>
// // //         <h3 className='text-info pt-4'>EXPLORE OUR SERVICES</h3>
// // //       </div>
...
// // //               <p className="card-text">We offer KPO services that enable businesses to leverage our expertise in data analysis, research, and other knowledge-intensive tasks to gain valuable insights and make informed decisions.
// // //               </p>
// // //             </div>
// // //           </div>
// // //           <div className='col m-1'>
...
// // //               <p className="card-text">We're dedicated to helping businesses succeed online. With our digital marketing expertise, we help companies grow their online presence, connect with their audience, and reach their goals. Our team delivers tailored solutions to boost brand visibility, drive traffic, and increase conversions.</p>
// // //             </div>
// // //           </div>
...
// // //     <div
// // //       className={className}
// // //       style={{ ...style, display: "block", background: "#0579C6" }}
// // //       onClick={onClick}
// // //     />
// // //   );
// // // }
...
//     <div
//       className={className}
//       style={{ ...style, display: "block", background: "#0579C6", borderRadius: "50%" }}
//       onClick={onClick}
//     />
//   );
// }
